...
------------ | ------------- | ------------- | -------------
**requests** | **Number** | Number of requests processed. | [optional] 
**hits** | **Number** | Number of cache hits. | [optional] 
**hits_time** | **Number** | Total amount of time spent processing cache hits (in seconds). | [optional] 
**miss** | **Number** | Number of cache misses. | [optional] 
**miss_time** | **Number** | Total amount of time spent processing cache misses (in seconds). | [optional] 
**pass** | **Number** | Number of requests that passed through the CDN without being cached. | [optional] 
...
**hit_ratio** | **Number** | Ratio of cache hits to cache misses (between 0 and 1). | [optional] 
**bandwidth** | **Number** | Total bytes delivered (`resp_header_bytes` + `resp_body_bytes` + `bereq_header_bytes` + `bereq_body_bytes` + `compute_resp_header_bytes` + `compute_resp_body_bytes` + `compute_bereq_header_bytes` + `compute_bereq_body_bytes` + `websocket_resp_header_bytes` + `websocket_resp_body_bytes` + `websocket_bereq_header_bytes` + `websocket_bereq_body_bytes` + `fanout_resp_header_bytes` + `fanout_resp_body_bytes` + `fanout_bereq_header_bytes` + `fanout_bereq_body_bytes`). | [optional] 
**body_size** | **Number** | Total body bytes delivered (alias for resp_body_bytes). | [optional] 
**header_size** | **Number** | Total header bytes delivered (alias for resp_header_bytes). | [optional] 
**req_body_bytes** | **Number** | Total body bytes received. | [optional] 
**req_header_bytes** | **Number** | Total header bytes received. | [optional] 
**resp_body_bytes** | **Number** | Total body bytes delivered (edge_resp_body_bytes + shield_resp_body_bytes). | [optional] 
**resp_header_bytes** | **Number** | Total header bytes delivered (edge_resp_header_bytes + shield_resp_header_bytes). | [optional] 
...
**pipe** | **Number** | Optional. Pipe operations performed (legacy feature). | [optional] 
**synth** | **Number** | Number of requests that returned a synthetic response (i.e., response objects created with the `synthetic` VCL statement). | [optional] 
...
**status_530** | **Number** | Number of responses sent with status code 530. | [optional] 
...
**compute_service_bereq_error** | **Number** | Number of backend request errors, including timeouts. | [optional] 
...
**compute_service_memory_exceeded_error** | **Number** | Number of times a guest exceeded its heap limit. | [optional] 
...
**ddos_protection_requests_detect_count** | **Number** | Number of requests classified as a DDoS attack against a customer origin or service. | [optional] 
**ddos_protection_requests_mitigate_count** | **Number** | Number of requests classified as a DDoS attack against a customer origin or service that were mitigated by the Fastly platform. | [optional] 
**ddos_protection_requests_allow_count** | **Number** | Number of requests analyzed for DDoS attacks against a customer origin or service, but with no DDoS detected. | [optional] 
**object_storage_class_a_operations_count** | **Number** | A count of the number of Class A Object Storage operations. | [optional] 
**object_storage_class_b_operations_count** | **Number** | A count of the number of Class B Object Storage operations. | [optional] 
**aia_requests** | **Number** | Number of requests received by AI Accelerator. | [optional] 
**aia_status_1xx** | **Number** | Number of \&quot;Informational\&quot; category status codes received from AI provider. | [optional] 
**aia_status_2xx** | **Number** | Number of \&quot;Success\&quot; status codes received from AI provider. | [optional] 
**aia_status_3xx** | **Number** | Number of \&quot;Redirection\&quot; received from AI provider. | [optional] 
**aia_status_4xx** | **Number** | Number of \&quot;Client Error\&quot; received from AI provider. | [optional] 
**aia_status_5xx** | **Number** | Number of \&quot;Server Error\&quot; received from AI provider. | [optional] 
**aia_response_usage_tokens** | **Number** | The usage tokens associated with the response returned from the AI Accelerator cache. | [optional] 
**aia_origin_usage_tokens** | **Number** | The number of usage tokens reported by the request to the origin from AI Accelerator. | [optional] 
**aia_estimated_time_saved_ms** | **Number** | The estimated amount of time saved by responses served from the AI Accelerator semantic cache. | [optional] 
...
**ngwaf_requests_allowed_count** | **Number** | Count of Next-Gen WAF (Edge WAF &amp; Core WAF) requests allowed. | [optional] 
...
**compute_resp_status_103** | **Number** | Number of responses delivered with status code 103 (Early Hints) by the Compute platform. | [optional] 
**compute_resp_status_200** | **Number** | Number of responses delivered with status code 200 (Success) by the Compute platform. | [optional] 
**compute_resp_status_204** | **Number** | Number of responses delivered with status code 204 (No Content) by the Compute platform. | [optional] 
**compute_resp_status_206** | **Number** | Number of responses delivered with status code 206 (Partial Content) by the Compute platform. | [optional] 
**compute_resp_status_301** | **Number** | Number of responses delivered with status code 301 (Moved Permanently) by the Compute platform. | [optional] 
**compute_resp_status_302** | **Number** | Number of responses delivered with status code 302 (Found) by the Compute platform. | [optional] 
**compute_resp_status_304** | **Number** | Number of responses delivered with status code 304 (Not Modified) by the Compute platform. | [optional] 
**compute_resp_status_400** | **Number** | Number of responses delivered with status code 400 (Bad Request) by the Compute platform. | [optional] 
**compute_resp_status_401** | **Number** | Number of responses delivered with status code 401 (Unauthorized) by the Compute platform. | [optional] 
**compute_resp_status_403** | **Number** | Number of responses delivered with status code 403 (Forbidden) by the Compute platform. | [optional] 
**compute_resp_status_404** | **Number** | Number of responses delivered with status code 404 (Not Found) by the Compute platform. | [optional] 
**compute_resp_status_416** | **Number** | Number of responses delivered with status code 416 (Range Not Satisfiable) by the Compute platform. | [optional] 
**compute_resp_status_429** | **Number** | Number of responses delivered with status code 429 (Too Many Requests) by the Compute platform. | [optional] 
**compute_resp_status_500** | **Number** | Number of responses delivered with status code 500 (Internal Server Error) by the Compute platform. | [optional] 
**compute_resp_status_501** | **Number** | Number of responses delivered with status code 501 (Not Implemented) by the Compute platform. | [optional] 
**compute_resp_status_502** | **Number** | Number of responses delivered with status code 502 (Bad Gateway) by the Compute platform. | [optional] 
**compute_resp_status_503** | **Number** | Number of responses delivered with status code 503 (Service Unavailable) by the Compute platform. | [optional] 
**compute_resp_status_504** | **Number** | Number of responses delivered with status code 504 (Gateway Timeout) by the Compute platform. | [optional] 
...
**ngwaf_bot_analysis_request_count** | **Number** | Count of Next-Gen WAF Bot Management requests. | [optional] 
**imgopto_avif_count** | **Number** | Count of AVIF images delivered to end user by Image Optimizer. | [optional] 
**imgopto_jpeg_count** | **Number** | Count of JPEG images delivered to end user by Image Optimizer. | [optional] 
**imgopto_png_count** | **Number** | Count of PNG images delivered to end user by Image Optimizer. | [optional] 
**imgopto_gif_count** | **Number** | Count of GIF images delivered to end user by Image Optimizer. | [optional] 
**imgopto_webp_count** | **Number** | Count of WebP images delivered to end user by Image Optimizer. | [optional] 
**imgopto_jpegxl_count** | **Number** | Count of JPEGXL images delivered to end user by Image Optimizer. | [optional] 
**imgopto_svg_count** | **Number** | Count of SVG images delivered to end user by Image Optimizer. | [optional] 
**imgopto_mp4_count** | **Number** | Count of MP4s delivered to end user by Image Optimizer. | [optional] 
**compute_service_resource_limits_error** | **Number** | Aggregate of fatal errors caused by exceeding allocated resource limits, specifically runtime duration, vCPU usage, and heap memory limits. | [optional] 
**compute_service_runtime_error** | **Number** | Fatal errors caused by service logic faults, including stack overflows, unreachable code traps, illegal memory access, or attempts to send multiple responses. | [optional] 
**compute_service_chain_error** | **Number** | Fatal errors caused by the service path exceeding hop or service limits, or where a forwarding loop is detected via CDN-Loop headers. | [optional] 
**compute_platform_internal_error** | **Number** | Fatal errors caused by internal errors in Fastly’s Compute platform. | [optional] 
**compute_service_timeout_error** | **Number** | Fatal errors caused by exceeding the per-request runtime limit. | [optional] 
**compute_service_vcpu_exceeded_error** | **Number** | Fatal errors caused by exceeding the per-request vCPU time limit. | [optional] 
**compute_service_limits_error** | **Number** | Non-fatal errors caused by attempts to exceed defined operational limits, such as simultaneous backend requests or cache transactions. | [optional] 
**compute_platform_invalid_request_error** | **Number** | Fatal errors caused by unprocessable requests to the service, such as requests with malformed CDN-Loop headers or invalid purge credentials. | [optional] 
**compute_sandboxes** | **Number** | Number of WebAssembly (Wasm) sandboxes created. | [optional] 
**bot_requests_total_count** | **Number** | Total number of Bot Management requests across all deployments. | [optional] 
**bot_edge_requests_analyzed_count** | **Number** | Count of edge requests where bot detection analysis was performed. | [optional] 
**bot_edge_requests_detected_count** | **Number** | Count of edge requests where a bot was detected. | [optional] 
**bot_edge_requests_verified_count** | **Number** | Count of edge requests where a verified bot was detected. | [optional] 
**bot_edge_requests_ai_crawler_count** | **Number** | Count of edge requests where an AI crawler was detected. | [optional] 
**bot_edge_requests_ai_fetcher_count** | **Number** | Count of edge requests where an AI fetcher was detected. | [optional] 
**bot_edge_requests_accessibility_count** | **Number** | Count of edge requests where an accessibility bot was detected. | [optional] 
**bot_edge_requests_content_fetcher_count** | **Number** | Count of edge requests where a content fetcher was detected. | [optional] 
**bot_edge_requests_monitoring_count** | **Number** | Count of edge requests where a monitoring and site tool was detected. | [optional] 
**bot_edge_requests_online_marketing_count** | **Number** | Count of edge requests where an online marketing bot was detected. | [optional] 
**bot_edge_requests_page_preview_count** | **Number** | Count of edge requests where a page preview bot was detected. | [optional] 
**bot_edge_requests_platform_integrations_count** | **Number** | Count of edge requests where a platform integration was detected. | [optional] 
**bot_edge_requests_research_count** | **Number** | Count of edge requests where a research bot was detected. | [optional] 
**bot_edge_requests_search_engine_crawler_count** | **Number** | Count of edge requests where a search engine crawler was detected. | [optional] 
**bot_edge_requests_search_engine_optimization_count** | **Number** | Count of edge requests where a search engine optimization bot was detected. | [optional] 
**bot_edge_requests_security_tools_count** | **Number** | Count of edge requests where a security tool was detected. | [optional] 
**compute_handoff** | **Number** | The number of times Compute has handed off a request to the Fanout proxy or WebSocket proxy. | [optional] 
**compute_service_bereq_dns_error** | **Number** | Number of backend requests from a Compute service that failed during DNS resolution. | [optional] 
**compute_service_bereq_conn_timeout_error** | **Number** | Number of backend requests from a Compute service where the connection to the origin timed out before being established. | [optional] 
**compute_service_bereq_conn_refused_error** | **Number** | Number of backend requests from a Compute service where the origin actively refused the connection. | [optional] 
**compute_service_bereq_conn_other_error** | **Number** | Number of backend requests from a Compute service that failed due to a connection error not classified as a timeout or refusal. | [optional] 
**compute_service_bereq_tls_server_cert_error** | **Number** | Number of backend requests from a Compute service that failed due to a TLS certificate validation error (e.g., expired, untrusted CA, hostname mismatch). | [optional] 
**compute_service_bereq_tls_other_error** | **Number** | Number of backend requests from a Compute service that failed due to a TLS error not classified as a certificate error. | [optional] 
**compute_service_bereq_http_proto_v1_error** | **Number** | Number of backend requests from a Compute service that failed due to an HTTP/1.x protocol violation after the request was transmitted. | [optional] 
**compute_service_bereq_http_proto_v2_error** | **Number** | Number of backend requests from a Compute service that failed due to an HTTP/2 protocol error, typically a `RST_STREAM` or `GO_AWAY` from the origin. | [optional] 
**compute_service_bereq_http_incomplete_error** | **Number** | Number of backend requests from a Compute service where the origin sent an incomplete HTTP response. | [optional] 
**compute_service_bereq_http_timeout_error** | **Number** | Number of backend requests from a Compute service where the origin did not respond within the configured timeout period. | [optional] 
**compute_service_bereq_http_other_error** | **Number** | Number of backend requests from a Compute service that failed due to an HTTP-level error not classified in any category. | [optional] 
**compute_service_bereq_other_error** | **Number** | Number of backend requests from a Compute service that failed due to an error not classified into the DNS, connection, TLS, or HTTP categories. | [optional] 
**compute_service_bereq_5xx_error** | **Number** | Number of backend requests from a Compute service where the origin returned a 5xx status code. | [optional] 
**compute_service_bereq_conn_error** | **Number** | Number of backend requests from a Compute service that failed at the TCP connection level. Sum of `compute_service_bereq_conn_timeout_error`, `compute_service_bereq_conn_refused_error`, and `compute_service_bereq_conn_other_error`. | [optional] 
**compute_service_bereq_tls_error** | **Number** | Number of backend requests from a Compute service that failed during the TLS handshake or session with the origin. Sum of `compute_service_bereq_tls_server_cert_error` and `compute_service_bereq_tls_other_error`. | [optional] 
**compute_service_bereq_http_error** | **Number** | Number of backend requests from a Compute service that failed at the HTTP protocol level. Sum of `compute_service_bereq_http_proto_v1_error`, `compute_service_bereq_http_proto_v2_error`, `compute_service_bereq_http_incomplete_error`, `compute_service_bereq_http_timeout_error`, and `compute_service_bereq_http_other_error`. | [optional] 
**bot_challenges_pats_issued** | **Number** | Number of Private Access Token challenges issued. | [optional]
**bot_challenges_pats_succeeded** | **Number** | Number of successful Private Access Token challenge solutions processed. | [optional]
